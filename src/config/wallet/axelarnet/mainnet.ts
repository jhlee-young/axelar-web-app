...
//** xpla */
const XPLA_CHAIN_ID: string = "dimension_37-1"
const XPLA_RPC: string = "https://dimension-rpc.xpla.dev"
const XPLA_REST = "https://dimension-lcd.xpla.dev"
